...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import acl_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("ed5aba05-e74d-5cf7-8b09-107ba3463b8e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "acl", artifacts_toml) for e in artifacts["acl"]]
...
if best_platform === nothing
    @debug("Unable to load acl; unsupported platform $(triplet(platform_key_abi()))")
else
